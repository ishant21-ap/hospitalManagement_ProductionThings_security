...
INSERT INTO doctor (email, name, specialization)
VALUES
    ('rakesh.mehta@example.com', 'Dr. Rakesh Mehta', 'Cardiology'),
    ('sneha.kapoor@example.com', 'Dr. Sneha Kapoor', 'Dermatology'),
    ('arjun.nair@example.com', 'Dr. Arjun Nair', 'Orthopedics');
